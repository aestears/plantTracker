...
small-scale maps of plant occurrence in quadrats, it is conceivably possible to 
...
frame. For this example, I'll use data from Central Plains Experimental Research 
...
following code reads in those shapefiles, transforms the points to polygons of a 
